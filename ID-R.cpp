...
int main() {
    ...
    cout << "The combination of Incidence Degree and Random Heuristic Order Coloring of the vertices:\n";
    for (int i = 0; i < V; ++i) {
        cout << "Vertex " << incidenceDegreeOrder[i] << ": Color " << randomOrder[incidenceDegreeOrder[i]] << "\n";
    }
